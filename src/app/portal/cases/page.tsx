  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <h1 className="font-display text-2xl font-bold text-[#0A1628]">My Cases</h1>
        <Link href="/portal/new-order" className="bg-[#C9A84C] text-[#0A1628] px-5 py-2.5 font-semibold rounded-sm hover:bg-[#E8C96A] text-sm">New Order</Link>
      </div>
