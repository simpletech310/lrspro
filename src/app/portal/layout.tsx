      ...
      <header className="bg-[#0A1628] text-white">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            <Link href="/portal/dashboard" className="text-slate-300 hover:text-white">Dashboard</Link>
            <Link href="/portal/cases" className="text-slate-300 hover:text-white">My Cases</Link>
            <Link href="/portal/documents" className="text-slate-300 hover:text-white">Documents</Link>
