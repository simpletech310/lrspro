    ...
    <section className="bg-white py-20 sm:py-24">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12 sm:mb-16">
          <span className="text-[#C9A84C] text-sm font-medium tracking-widest uppercase">From Order to Affidavit</span>
          <h2 className="font-display text-[#0A1628] text-3xl sm:text-4xl font-bold mt-2">Three Steps. Total Transparency.</h2>
          <p className="text-slate-500 mt-3 max-w-2xl mx-auto">No phone tag. No wondering where your case stands. Place your order online, and we handle the rest — with full documentation at every stage.</p>
        </div>
