...
export async function Testimonials() {
  ...
  const tagline = content.tagline || 'From Our Clients'
  const heading = content.heading || 'Trusted by Legal Professionals Across Southern California'
    ...
    <section className="bg-[#F8F5EE] py-20 sm:py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
          {items.map(({ quote, author, role, firm }: any) => (
